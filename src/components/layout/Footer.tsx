...
import { ArrowRight, Github, Instagram, MessageSquare, Mail, MapPin, Phone } from "lucide-react";
      ...
      <div className="container mx-auto py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 md:gap-8 px-4 sm:px-6 md:px-8">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              ...
              <Button variant="outline" size="icon" className="rounded-full h-9 w-9 transition-colors hover:bg-primary hover:text-primary-foreground" asChild>
                <a href="https://www.instagram.com/community.codex/" target="_blank" rel="noreferrer">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-muted-foreground px-4 sm:px-6 md:px-8">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end gap-x-6 gap-y-2">
            <Link to="/privacy-policy" className="hover:text-foreground transition-colors text-xs">Privacy Policy</Link>
            <Link to="/terms-of-service" className="hover:text-foreground transition-colors text-xs">Terms of Service</Link>
            <Link to="/support" className="hover:text-foreground transition-colors text-xs">Support</Link>
          </div>
        </div>
